...
function renderMarketIntelligence() {
  ...
  new TradingView.widget({
    container_id: 'tv-economic-calendar',
    width: '100%',
    height: '400',
    colorTheme: 'light',
    isTransparent: false,
  ...
  earningsScript.src = 'https://s3.tradingview.com/external-embedding/embed-widget-events.js';
  ...
  document.getElementById('tv-earnings-calendar').appendChild(earningsScript);
  ...
  document.getElementById('tv-market-news').appendChild(newsScript);
}
